...
<div id="work-collections" class="seaction">
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        <span>Copyright © 2022 <a class="grey-text text-lighten-4" href="#" target="_blank">RODA | IT</a> All Rights Reserved!</span>
        <span class="right"> Design and Developed by <a class="grey-text text-lighten-4" href="#">CODERODA</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
